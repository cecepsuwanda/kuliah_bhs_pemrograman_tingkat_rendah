...
\subsection{Alternatif assembler modern (NASM)}
...
\begin{itemize}
  ...
  \item String untuk \texttt{AH=09h}: pastikan terminator karakter \texttt{'$'} hadir; untuk \texttt{INT 10h} tidak diperlukan.
\end{itemize}
