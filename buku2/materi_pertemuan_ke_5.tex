...
\subsubsection{SHIFT dan ROTATE}
Operasi geser dan rotasi penting untuk manipulasi bit tingkat rendah, multiplikasi/divisi basis 2, serta ekstraksi bit-field. \cite{intel2019manual32}
\begin{itemize}
  \item \textbf{SHL/SAL}: geser ke kiri; mengalikan tak bertanda dengan 2 per langkah; bit keluar ke \texttt{CF}.
  \item \textbf{SHR}: geser ke kanan tak bertanda; membagi dengan 2 per langkah; bit keluar ke \texttt{CF}.
...
\begin{verbatim}
mov ax, 0001h
shl ax, 1     ; AX = 0002h, CF=0
ror ax, 1     ; rotasi kanan; bit0 masuk ke bit15
\end{verbatim}
