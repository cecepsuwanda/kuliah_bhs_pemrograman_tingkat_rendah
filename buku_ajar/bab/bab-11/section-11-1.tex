...
\begin{tabular}{|p{2cm}|p{2.5cm}|p{2.5cm}|p{2.5cm}|p{1.7cm}|}
\hline
\textbf{Kriteria} & \textbf{Excellent (4)} & \textbf{Good (3)} & \textbf{Fair (2)} & \textbf{Poor (1)} \\
\hline
Correctness & No bugs, perfect & Minor bugs, good & Some bugs, basic & Major bugs \\
\hline
Efficiency & Optimized, minimal cycles & Good optimization & Basic optimization & No optimization \\
\hline
Readability & Well documented, clear & Good documentation & Basic documentation & Poor/no docs \\
\hline
Modularity & Excellent modular design & Good modular design & Basic modularization & No modularity \\
\hline
Error Handling & Comprehensive handling & Good handling & Basic handling & No handling \\
\hline
\end{tabular}
...
\textbf{Kriteria} & \textbf{Excellent (4)} & \textbf{Good (3)} & \textbf{Fair (2)} & \textbf{Poor (1)} \\
\hline
Analysis & Deep understanding & Good understanding & Basic understanding & Poor understanding \\
\hline
Algorithm Design & Optimal algorithm & Good algorithm & Basic algorithm & Poor algorithm \\
\hline
Implementation & Flawless impl. & Good impl. & Basic impl. & Poor impl. \\
\hline
