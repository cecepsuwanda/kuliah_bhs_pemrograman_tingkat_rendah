...
% --- Suppress Empty thebibliography warning (bab standalone tanpa citation) ---
\usepackage{silence}
\WarningFilter*{latex}{Empty}
...
% Style untuk Assembly (x86masm) - untuk kode Assembly Intel 8086
...
% Command untuk highlight istilah Assembly
\newcommand{\asm}[1]{\textbf{\texttt{#1}}}
...
% --- Pengaturan typography untuk mengurangi bad box ---
\sloppy
\tolerance=2500
